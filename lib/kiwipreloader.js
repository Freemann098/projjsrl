...
KiwiLoadingScreen.prototype.loadProgress = function (percent, bytesLoaded, file) {
	...
	if(file.key === 'loadingJSON') {
		...
		this.loadingTween.to({ alpha: 1 }, 2000, Kiwi.Animations.Tweens.Easing.Linear.None);
...
KiwiLoadingScreen.prototype.fadeOutHTML5 = function() {
	...
	this.loadingTween.to({ kiwiAlpha : 1 }, 1, Kiwi.Animations.Tweens.Easing.Linear.None);
