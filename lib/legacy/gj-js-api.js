...
let nuzq = "2591c03b257c51fdb8e1c43d776dc6bf";

// ****************************************************************
// configuration attributes
GJAPI.iGameID    = 409380;      // # change this
GJAPI.sGameKey   = window.btoa(nuzq);     // # change this too
...
GJAPI.SendRequestEx = function(sURL, bSendUser, sFormat, sBodyData, pCallback)
{
    ...
    sURL += "&signature=" + hex_md5(sURL + window.atob(GJAPI.sGameKey));
